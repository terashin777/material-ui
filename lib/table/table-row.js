...
var TableRow = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        style = _props.style,
        other = _objectWithoutProperties(_props, ['className', 'displayBorder', 'hoverable', 'onCellClick', 'onCellHover', 'onCellHoverExit', 'onRowClick', 'onRowHover', 'onRowHoverExit', 'rowNumber', 'selectable', 'selected', 'striped', 'style']);
