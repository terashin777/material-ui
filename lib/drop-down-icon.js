...
var DropDownIcon = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        closeOnMenuItemTouchTap = _props.closeOnMenuItemTouchTap,
        iconStyle = _props.iconStyle,
        iconLigature = _props.iconLigature,
        iconClassName = _props.iconClassName,
        other = _objectWithoutProperties(_props, ['style', 'children', 'menuItems', 'closeOnMenuItemTouchTap', 'iconStyle', 'iconLigature', 'iconClassName']);
