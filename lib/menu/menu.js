...
var NestedMenuItem = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['index', 'menuItemStyle']);
  ...
  _getChildren: function _getChildren() {
    ...
    for (var i = 0; i < this.props.menuItems.length; i++) {
      ...
      var _menuItem = menuItem,
          ...
          onTouchTap = _menuItem.onTouchTap,
          other = _objectWithoutProperties(_menuItem, ['icon', 'data', 'attribute', 'number', 'toggle', 'onTouchTap']);
      ...
      switch (menuItem.type) {
        ...
        case _menuItem3.default.Types.NESTED:
          var _props2 = this.props,
              ...
              _other = _objectWithoutProperties(_props2, ['zDepth']);
