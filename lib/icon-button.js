...
var IconButton = _react2.default.createClass({
  ...
  getStyles: function getStyles() {
    var _constructor$getRelev = this.constructor.getRelevantContextKeys(this.state.muiTheme),
        iconSize = _constructor$getRelev.iconSize,
        textColor = _constructor$getRelev.textColor,
        disabledColor = _constructor$getRelev.disabledColor;
  ...
  render: function render() {
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['disabled', 'iconClassName', 'tooltip', 'touch', 'iconStyle']);
