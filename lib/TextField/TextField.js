...
var TextField = _react2.default.createClass({
  ...
  getStyles: function getStyles() {
    ...
    var _constructor$getRelev = this.constructor.getRelevantContextKeys(this.state.muiTheme),
        floatingLabelColor = _constructor$getRelev.floatingLabelColor,
        focusColor = _constructor$getRelev.focusColor,
        textColor = _constructor$getRelev.textColor,
        disabledTextColor = _constructor$getRelev.disabledTextColor,
        backgroundColor = _constructor$getRelev.backgroundColor,
        hintColor = _constructor$getRelev.hintColor,
        errorColor = _constructor$getRelev.errorColor;
  ...
  render: function render() {
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['className', 'disabled', 'errorStyle', 'errorText', 'floatingLabelText', 'fullWidth', 'hintText', 'hintStyle', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'style', 'type', 'underlineDisabledStyle', 'underlineFocusStyle', 'underlineShow', 'underlineStyle', 'rows', 'rowsMax']);
