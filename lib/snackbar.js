...
var Snackbar = _react2.default.createClass({
  ...
  getStyles: function getStyles() {
    var _constructor$getRelev = this.constructor.getRelevantContextKeys(this.state.muiTheme),
        ...
        desktopGutter = _constructor$getRelev.desktopGutter,
        desktopSubheaderHeight = _constructor$getRelev.desktopSubheaderHeight,
        actionColor = _constructor$getRelev.actionColor;
