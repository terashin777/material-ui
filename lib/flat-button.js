...
var FlatButton = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        style = _props.style,
        other = _objectWithoutProperties(_props, ['children', 'disabled', 'hoverColor', 'backgroundColor', 'label', 'labelStyle', 'labelPosition', 'primary', 'rippleColor', 'secondary', 'style']);

    var _constructor$getRelev = this.constructor.getRelevantContextKeys(this.state.muiTheme),
        buttonColor = _constructor$getRelev.buttonColor,
        buttonHeight = _constructor$getRelev.buttonHeight,
        buttonMinWidth = _constructor$getRelev.buttonMinWidth,
        disabledTextColor = _constructor$getRelev.disabledTextColor,
        buttonFilterColor = _constructor$getRelev.buttonFilterColor,
        primaryTextColor = _constructor$getRelev.primaryTextColor,
        secondaryTextColor = _constructor$getRelev.secondaryTextColor,
        textColor = _constructor$getRelev.textColor,
        textTransform = _constructor$getRelev.textTransform;
