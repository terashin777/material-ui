...
var DropDownMenu = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var _props2 = this.props,
        ...
        labelMember = _props2.labelMember,
        ...
        _props2$valueMember = _props2.valueMember,
        valueMember = _props2$valueMember === undefined ? 'payload' : _props2$valueMember,
        other = _objectWithoutProperties(_props2, ['autoWidth', 'children', 'className', 'displayMember', 'iconStyle', 'labelMember', 'labelStyle', 'maxHeight', 'menuItems', 'menuStyle', 'style', 'underlineStyle', 'valueLink', 'valueMember']);

    var _state = this.state,
        anchorEl = _state.anchorEl,
        open = _state.open,
        muiTheme = _state.muiTheme;
