...
var EnhancedSwitch = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        defaultSwitched = _props.defaultSwitched,
        ...
        other = _objectWithoutProperties(_props, ['name', 'value', 'label', 'onSwitch', 'defaultSwitched', 'onBlur', 'onFocus', 'onMouseUp', 'onMouseDown', 'onMouseLeave', 'onTouchStart', 'onTouchEnd', 'disableTouchRipple', 'disableFocusRipple', 'className']);
