...
var DialogInline = _react2.default.createClass({
  ...
  _positionDialog: function _positionDialog() {
    var _props3 = this.props,
        ...
        autoDetectWindowHeight = _props3.autoDetectWindowHeight,
        autoScrollBodyContent = _props3.autoScrollBodyContent,
        bodyStyle = _props3.bodyStyle,
        open = _props3.open,
        repositionOnUpdate = _props3.repositionOnUpdate,
        title = _props3.title;
  ...
  render: function render() {
    var _props4 = this.props,
        ...
        actionsContainerClassName = _props4.actionsContainerClassName,
        actionsContainerStyle = _props4.actionsContainerStyle,
        bodyClassName = _props4.bodyClassName,
        bodyStyle = _props4.bodyStyle,
        children = _props4.children,
        className = _props4.className,
        contentClassName = _props4.contentClassName,
        contentStyle = _props4.contentStyle,
        overlayClassName = _props4.overlayClassName,
        overlayStyle = _props4.overlayStyle,
        open = _props4.open,
        titleClassName = _props4.titleClassName,
