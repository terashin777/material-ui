...
var DatePickerInline = function (_React$Component) {
  ...
  function DatePickerInline() {
    ...
    return _possibleConstructorReturn(this, (DatePickerInline.__proto__ || Object.getPrototypeOf(DatePickerInline)).apply(this, arguments));
  }
  ...
  _createClass(DatePickerInline, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          open = _props.open,
          style = _props.style,
          other = _objectWithoutProperties(_props, ['actions', 'children', 'open', 'style']);
