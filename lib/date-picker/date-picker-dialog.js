...
var DatePickerDialog = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['DateTimeFormat', 'locale', 'wordings', 'initialDate', 'onAccept', 'style', 'container', 'firstDayOfWeek']);

    var _constructor$getRelev = this.constructor.getRelevantContextKeys(this.state.muiTheme),
        calendarTextColor = _constructor$getRelev.calendarTextColor;
